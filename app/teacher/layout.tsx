...
import { 
    ...
    FaVideo, FaPenNib, FaBell, FaCircle, FaHistory, FaSignOutAlt
} from 'react-icons/fa';
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        ...
                        <button 
                            ...
                            style={{ 
                                ...
                                padding: '8px 15px', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', 
                                display: 'flex', alignItems: 'center', gap: '8px', transition: '0.3s', fontSize: '0.95rem'
                            }}
                            onMouseEnter={(e) => { e.currentTarget.style.background = '#ff4757'; e.currentTarget.style.color = 'white'; }}
                            onMouseLeave={(e) => { e.currentTarget.style.background = 'rgba(255, 71, 87, 0.1)'; e.currentTarget.style.color = '#ff4757'; }}
                        >
                            <FaSignOutAlt /> خروج
                        </button>
                            ...
                            {isNotificationsOpen && (
                                <div style={{ 
                                    ...
                                    <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                                        <Link href="/teacher/courses" onClick={() => setIsNotificationsOpen(false)} style={{ display: 'block', textDecoration: 'none', padding: '15px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                                            <div style={{ color: 'var(--txt)', fontSize: '0.95rem', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                <FaCircle color="#3498db" size={8}/> إشعار جديد
                                            </div>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div style={{ textAlign: 'left', direction: 'ltr', paddingRight: '15px', borderRight: '1px solid rgba(255,255,255,0.1)' }}>
                            <div style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--txt)' }}>المدرس</div>
                        </div>
