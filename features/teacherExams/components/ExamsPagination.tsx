// FILE: features/teacherExams/components/ExamsPagination.tsx
...
export default function ExamsPagination({ currentPage, totalPages, totalItems, onPageChange }: Props) {
    return (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '20px', padding: '10px 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            <div style={{ color: 'var(--txt-mut)', fontSize: '0.9rem' }}>
                إجمالي الامتحانات: <strong style={{ color: 'white' }}>{totalItems}</strong>
            </div>
